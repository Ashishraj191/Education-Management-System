<?php
    ...
    <ul class="navbar-nav">
      <li class="nav-item">
        <a class="nav-link  active" href="../student panel/index.php">
      ...
      <li class="nav-item">
        <a class="nav-link  " href="../student panel/course.php">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
      ...
      <li class="nav-item">
        ...
        <ul class="dropdown-menu mx-4 mt-0" aria-labelledby="dropdownMenuButton">
          <li><a class="dropdown-item" href="../student panel/meeting.php">Join Meeting</a></li>
          <li><a class="dropdown-item" href="../student panel/liveClasses.php">Live Classes</a></li>
        </ul> 
      </li>
      <li class="nav-item">
        <a class="nav-link  " href="../student panel/content.php">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
              <title>office</title>
              <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
          ...
          <span class="nav-link-text ms-1">Course Content</span>
        </a>
      </li>
      <li class="nav-item">
        <a class="nav-link  " href="../student panel/testSeries.php">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
              <title>office</title>
              <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
          ...
          <span class="nav-link-text ms-1">Test Series</span>
        </a>
      </li>
      <li class="nav-item">
      ...
      <li class="nav-item">
        <a class="nav-link  " href="../pages/billing.html">
          ...
          <span class="nav-link-text ms-1">G.D Room</span>
        </a>
      </li>
      <li class="nav-item">
