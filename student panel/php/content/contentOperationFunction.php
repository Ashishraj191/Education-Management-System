        ...
        if (mysqli_num_rows($result)>0) {
            while ($row = mysqli_fetch_array($result)){
                ...
                if ($type == 'table'){
                    ...
                    echo '<div class="col-sm folderDiv">
                    <input type="number" id="category" value="'.$row['category_id'].'" hidden>
                    <img class="folderImg" src="../assets/img/floder2.png" alt="" srcset="">
        ...
        if (mysqli_num_rows($result)>0) {
            while ($row = mysqli_fetch_array($result)){
                ...
                if ($type == 'table'){
                    ...
                    echo '<div class="col-sm folderDiv2">
                    <input type="number"  value="'.$row['sub_category_id'].'" hidden>
                    <img class="subfolderImg" src="../assets/img/floder2.png" alt="" srcset="">
        ...
        if (mysqli_num_rows($result)>0) {
            while ($row = mysqli_fetch_array($result)){
                ...
                if ($type == 'table'){
                    ...
                    echo '<div class="col-sm contentListDiv">
                    <input type="number"  value="'.$row['content_id'].'" hidden>
                    <img class="folderImg" src="../assets/img/floder2.png" alt="" srcset="">
            ...
            echo '<tr>
            <td>
                <p class="text-sm font-weight-bold mb-0">No Video found !</p>
            </td>';
        }
    }
?>