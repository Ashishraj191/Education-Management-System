    ...
    function viewAllTestSeries($conn,$center_id){
        ...
        if (mysqli_num_rows($result)>0) {
            while ($row = mysqli_fetch_array($result)) {
                ...
                echo'
                <td class="py-0">
                  <button class="btn btn-icon btn-3 p-2 m-0 bg-gradient-danger my-0 view_editMeeting question_btn" data-bs-toggle="modal" data-bs-target="#questionModal" value="'.$row['test_series_id'].'">
                      <span class="btn-inner--icon"><i class="ni ni-button-play"></i></span>
                      <span class="btn-inner--text">Start Test</span>
                  </button>
                </td>
              </tr>';
            }
